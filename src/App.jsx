    ...
    <div className="min-h-screen">
      ...
      <section className='max mt-15'>
        ...
        <img src={image.discoBlue} alt="Dancing!" className='disco'/>
          ...
          <p>
          Good. Because we're getting married, and you <i>know</i> we've got good taste in music.</p>
          <p> Come on up to Chicago on August 8th, 2026 to celebrate with us beneath an excessive number of disco balls (yes, really) and the ungovernable influence of actually really good espresso martinis.
          </p>
        </div>
      </section>
